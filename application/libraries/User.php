	...
	public function __construct() 
	{
		...
		$this->oauth_secret = $CI->input->cookie($config . "oauthsecret", TRUE);
 		...
 		$select = "users.`ID`, users.`username`, users.`email`, 
				...
				users.profile_view, users.posts_view, users.post_profile,users.online_status,
				users.rings,
				users.allow_friends, users.allow_pages, users.chat_option,
				users.oauth_provider,
				users.firends_show,users.uploads_show,users.intro_show,
				users.profiles_show,users.covers_show,
