...
public function edit_family($id)
  ...
  public function update_p_location()
	...
	public function getmemberprofilesbysearchid($id)
	{
		...
		<div style="border: 1px solid #DDD; border-radius: 2px; display: flex;">
			<div style="width: 200px; height: 200px;">
				<img style="width: 100%;height: 100%;" src="'.base_url().$this->settings->info->upload_path_relative.'/'.$getmember->profileimage.'">
			</div>
			<div style="margin-left: 10px; padding: 10px;">
				...
				<div style="padding: 5px;">
					<b>Age:</b><span style="padding-left: 50px;">'.$getmember->year_of_birth.' Years</span>
				</div>
				<div style="padding: 5px;">
					<b>Religion:</b><span style="padding-left: 20px;">Muslim</span>
				</div>
				<div style="padding: 5px;">
					<b>Country:</b><span style="padding-left: 20px;">'.$getmember->country.'</span>
				</div>
			</div>
		</div>
	</div>';
	...
	public function quicksearch()
	{
		...
		<div style="border: 1px solid #DDD; border-radius: 2px; display: flex;">
			<div style="width: 200px; height: 200px;">
				<img style="width: 100%;height: 100%;" src="'.base_url().$this->settings->info->upload_path_relative.'/'.$r->profileimage.'">
			</div>
			<div style="margin-left: 10px; padding: 10px;">
				<div style="padding: 5px;">
				...
				<div style="padding: 5px;">
					<b>Country:</b><span style="padding-left: 20px;">'.$this->marriage_model->getcountryname($r->country)->row()->name.'</span>
				</div>
			</div>
		</div>
	</div>';
			...
			<div class="row">
				...
				<div class="col-md-7">
					<div style="margin-left: 10px; padding: 10px;">
						...
						<div >
							<b >Profile By:</b><span style="padding-left: 20px;"><a target="_blank" href="'.site_url("marriage/profile/").$this->marriage_model->getuser($r->users_id)->row()->username.'">'.$this->marriage_model->getuser($r->users_id)->row()->first_name.' '.$this->marriage_model->getuser($r->users_id)->row()->last_name.'</a></span>
						</div>
						<div>
							<b>Name:</b><span style="padding-left: 35px;">'.$r->first_name.' '.$r->last_name.'</span>
						</div>
						...
						<div >
							<b>Country:</b><span style="padding-left: 20px;">'.$countryname.'</span>
						</div>
