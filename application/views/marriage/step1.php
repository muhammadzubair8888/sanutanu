				...
				<input type="hidden" name="profileid" value="<?php echo $profileid; ?>">
		        	<div class="form-top">
		            	...
		            	<div class="row form-group">
		            		...
		            		<div class="col-md-9 ">
		            			<input value="<?php echo $this->user->info->city; ?>" type="text" name="city"  class="form-control" required="">
		            		</div>		            		
		            	</div>
		            	<div class="row form-group">
		            		<div class="col-md-3 ">
		            	...
		            	<div class="row form-group">
                          ...
                          <option value="">-Select-</option>	
		            		...
		            		<div class="col-md-9 ">
		            			<div class="row">
		            				<div class="col-md-4">
		            					<input type="radio" value="Traditional"  name="family_values" required=""> Traditional
		            				</div>
		            				<div class="col-md-4">
		            	...
		            	<div style="display: none;" id="showstate" class="row form-group" required="">
		            		<div class="col-md-3 ">
		            	...
		            	<div class="row form-group">
		            		...
		            		<div class="col-md-9 ">
								<textarea class="form-control" name="educational_description" required=""></textarea>
		            		</div>		            		
		            	</div>
		            	<div class="row form-group">
		            		<div class="col-md-3 ">
		            		...
		            		<div class="col-md-9 ">
								<input type="text" placeholder="IT Professional" class="form-control" name="ocupation" required="">
		            		</div>		            		
		            	</div>
		            	<div class="row form-group">
		            		<div class="col-md-3 ">
		            	...
		            	<div class="row form-group">
		            		...
		            		<div class="col-md-9 ">
		            			<select id="countryofresident" class="form-control" name="country_of_resedence" required="">
		            				<option value="">Select Country</option>
		            				<?php foreach ($countries->result() as $r) { ?>
		            					<option value="<?php  echo $r->id?>"><?php echo $r->name; ?></option>
		            				<?php } ?>
		            	...
		            	<div style="display: none;" id="showcityresident" class="row form-group" required="">
		            		<div class="col-md-3 ">
