...
<script type="text/javascript">
    ...
    if (marriageprofileid == "") {
      ...
      $.ajax({
        ...
        data: {
          message: msg,
          profileid: id,
          frommarriageid: marriageprofileid
        },
  ...
  function sendcontactsrequest(id) {
    ...
    if (marriageprofileid == "") {
      ...
      $("#messagecontact").css("border-color", "red");
      $("#errormessagecontactmessage").show();
    } else {
      $.ajax({
        ...
        <div style="border:1px solid #DDD; border-radius: 10px; padding: 10px;">
          <div class="row">
            <div class="col-md-9">
              <div style="padding: 10px;">
                ...
                <div style="margin-top: 10px;"><button class="btn btn-success btn-lg" onclick="chat_with(<?php echo $marriageprofile->users_id; ?>);">Send Message</button></div>
              </div>
            </div>
            <div class="col-md-3">
          ...
          <div id="requestcontactsshow" style="display: none;">
            ...
            <div>
              ...
              <span style="display: none; color: red;" id="errormessagecontactmessage">This is the Required.</span><br>
