...
<div class="row">
	<div class="col-md-3">
		<img style="width: 100%;height: 100%;" src="<?php echo base_url() ?>/uploads/7b287d01a491176a923915265ad9f973.gif">
	</div>
	<div class="col-md-9">
		<div>
...
<style type="text/css">
	...
	#showprofiles .btn, #hidenewstprofiles .btn{
		margin-top: 10px;
	}
</style>
<script type="text/javascript">
	function searchbyid() {
		...
		if (id === "") {
			...
			$('#hidenewstprofiles').addClass('addclass');
			$.ajax({
						...
						<div style="margin-left: 10px; padding: 10px;">
							...
							<div>
								...
								<span style="padding-left: 20px;">
									<?php if (!empty($r->relegion)) {
										echo $this->marriage_model->getreligionname($r->relegion)->row()->name;
									} else {
										echo " N/A ";
									} ?>
								</span>
							...
							<div>
								<b>Status:</b><span style="margin-left: 20px;"><?php if ($r->status == 1) { ?><span class="label label-info">Online </span><?php } else { ?> <span class="label label-danger">Ofline </span> <?php } ?></span>
							</div>
							<div style="text-align: right;">
								<a class="btn btn-success btn-view-mprofile" href="<?php echo site_url('marriage/view/') . $r->marriage_profile_id; ?>">View</a>
							</div>
...
<script type="text/javascript">
	function loadmore() {
		...
		$('#loadmorebutton').html('<img class="fa fa-spinner fa-spin"> Loading....');
		$.ajax({
