  ...
  <div class="row postbtnrow" style="background: #f5f6f7; margin: -10px; margin-top: 0px; padding-top: 10px; border-top: 1px solid #dddfe2; border-radius: 0 0 4px 4px; display: none;">
    <div class="col-md-12">
      <div style="display: flex;">
          <div class="editor-feedrow editor-feedrow-left">




            
            <div onclick="checkuncheck(0);" style="display: flex; align-items: center; padding: 0.4vw;"> 
              <div style="font-size: 22px; text-align: right;color: #a41be3; padding-right: 5px; padding-left: 5px;">
            ...
            <div class="row">
              <div class="col-md-12" style="text-align: center; padding-bottom: 0.4vw;">
          ...
          <div class="editor-feedrow  editor-feedrow-right">
            

          <div style="display: flex; align-items: center; padding: 0.4vw;" onclick="checkuncheck(1);">
            <div style="font-size: 22px; text-align: right;color: #a41be3; padding-right: 5px; padding-left: 5px;">
            ...
            <div style="padding-right: 5px; position: relative;">
            ...
            <div style="font-weight: bold;">Your Story</div>
          </div>

          <div class="row">
            <div class="col-md-12" style="text-align: center; padding-bottom: 0.4vw;">
              <div class="dropdown" style="z-index: 99; width: 50px !important; display: inline-block; padding: 5px; padding-bottom: 0;">
          ...
          <div style="padding:5px;">
            <input type="submit" class="btn btn-post btn-sm  olx" style="width: 100%;font-weight: bold;" value="<?php echo lang("ctn_506") ?>">
          </div>
