...
?>
  ...
  <div class="storybox">
    <div class="storybox-title">
      ...
      <div><a href="<?php echo base_url().'home/stories/' ?>" class="story-seeall">See All</a></div>
    </div>
...
?>
      ...
      <div class="userstorybox" tabindex="0" style="width:140px; height: 200px;" onclick="window.location = '<?php echo base_url().'home/stories/' ?>';">
...
?>
      ...
      <div class="userstorybox" tabindex="0" style="width:140px; height: 201px;" onclick="window.location = '<?php echo base_url().'home/stories/' ?>';">
        <div class="storyImageContainer" style="width:140px;height:200px; background: #000; color: #FFF; vertical-align: middle; text-align: center; display: table-cell;">
