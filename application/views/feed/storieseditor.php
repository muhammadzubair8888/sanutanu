...
<div class="editor-textarea-part"><textarea onclick="highlightPostBox();" name="content" class="editor-textarea" id="editor-textarea" placeholder="<?php if(isset($editor_placeholder)) : ?><?php echo $editor_placeholder ?><?php else : ?><?php echo lang("ctn_495") ?><?php endif; ?>"></textarea>
  <?php if(isset($postAs)) : ?>
    <input type="text" name="post_as" value="<?php echo $postAsDefault ?>" id="post_as">
                  ...
                  <table align="center">
                    <tr>
                      <td style="padding-right: 5px;font-size: 22px; text-align: center;color: #a41be3;">
                        <i class="storyfeed-unchecked far fa-circle" style="display: none;"></i>
                        <i class="storyfeed-checked fa fa-check-circle" style=""></i>
                        <input type="hidden" name="checkstory" id="checkstory" value="1" />
                      </td>
              ...
              <tr>
                <td style="text-align: center; padding: 5px;">
                  <div class="dropdown" style="z-index: 99; width: 100px !important; display: inline-block; padding: 5px; padding-bottom: 0;">
                    <input type="hidden" name="storyfor" id="storyfor" value="1">
          ...
          <td class="editor-feedrow" width="50%">
            ...
            <table style="width:100%;" border="0">
              ...
              <tr>
                <td class="editor-feedcol" style="padding: 5px 5px;text-align: center;" onclick="checkuncheck(0);">
                  <table align="center">
                    <tr>
                      <td style="padding-right: 5px;font-size: 22px; text-align: center;color: #a41be3;">
                        <i class="newsfeed-unchecked far fa-circle"></i>
                        <i class="newsfeed-checked fa fa-check-circle" style="display: none;"></i>
                        <input type="hidden" name="checkfeed" id="checkfeed" value="0" />
                      </td>
                      <td style="padding: 5px;">
              ...
              <tr>
                <td style="text-align: center; padding: 5px;">
                  <div class="dropdown" style="z-index: 99; width: 100px !important; display: inline-block; padding: 5px; padding-bottom: 0;">
                    <input type="hidden" name="postfor" id="postfor" value="1">
