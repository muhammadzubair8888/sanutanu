...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_959") ?></li>
</ol>
...
<tr class="table-header">
  <td width="50px"><?php echo lang("ctn_961") ?></td>
  <td width="90px"><?php echo lang("ctn_968") ?></td>
   ...
   var st = $('#search_type').val();
    var table = $('#member-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/report_abuse_posts_page") ?>",
            type : 'GET',
            data : function ( d ) {
