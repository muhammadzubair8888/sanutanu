...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_557") ?></td><td><?php echo lang("ctn_81") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#page-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("admin/group_categories_page") ?>",
            type : 'GET',
            data : function ( d ) {
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url("admin/add_group_category"), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    <label for="email-in" class="col-md-3 label-heading"><?php echo lang("ctn_81") ?></label>
                    <div class="col-md-9">
                        <input required="" type="text" class="form-control" id="email-in" name="name">
                    </div>
            </div>
             <div class="form-group">
