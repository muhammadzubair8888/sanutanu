...
function add_report_abuse_reason()
{
  ...
  {
    $.ajax({
      url: '<?php echo base_url(); ?>admin/report_abuse_reason_add',
      type: 'POST',
...
function save_edit_report_abuse_reason(id)
{
  ...
  {
    $.ajax({
      url: '<?php echo base_url(); ?>admin/report_abuse_reason_update/',
      type: 'POST',
...
function delete_report_abuse_reason(id)
{
  ...
  {
    $.ajax({
      url: '<?php echo base_url(); ?>admin/report_abuse_reason_delete',
      type: 'POST',
...
{
  $.ajax({
      url: '<?php echo base_url(); ?>admin/report_abuse_reason_load',
      type: 'POST',
