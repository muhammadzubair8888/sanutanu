...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_104") ?></li>
</ol>
...
<hr>
 ...
 <?php echo form_open(site_url("admin/edit_religion_pro/" . $religion->ID), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    <label for="email-in" class="col-md-3 label-heading"><?php echo lang("ctn_1043") ?></label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $religion->name ?>">
