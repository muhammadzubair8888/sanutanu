...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-user"></span> <?php echo lang("ctn_989") ?></div>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(site_url("home/add_user_group_cover_ad"), array("class" => "form-horizontal")) ?>
   ...
   var st = $('#search_type').val();
    var table = $('#member-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("home/user_group_cover_ad_page") ?>",
            type : 'GET',
            data : function ( d ) {
