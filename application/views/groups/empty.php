...
<?php echo $user->first_name ?> <?php echo $user->last_name ?>
 ...
 <ul>
  <li class="active"><a href="<?php echo site_url("groups/" . $user->username) ?>"><?php echo lang("ctn_200") ?></a></li>
  <li><a href="<?php echo site_url("groups/friends/" . $user->ID) ?>"><?php echo lang("ctn_493") ?></a></li>
  <li><a href="<?php echo site_url("groups/albums/" . $user->ID) ?>"><?php echo lang("ctn_483") ?></a></li>
 </ul>
...
<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#reportModal" title="<?php echo lang("ctn_578") ?>"><span class="glyphicon glyphicon-flag"></span></button>
 ...
 <div class="col-md-4">
    ...
    <div class="page-block separator">
        <div class="page-block-title">
          <span class="glyphicon glyphicon-user"></span> <a href="<?php echo site_url("groups/friends/" . $user->ID) ?>"><?php echo lang("ctn_493") ?></a>
        </div>
    ...
    <div class="page-block separator">
        <div class="page-block-title">
          <span class="glyphicon glyphicon-picture"></span> <a href="<?php echo site_url("groups/albums/" . $group->ID) ?>"><?php echo lang("ctn_483") ?></a>
        </div>
        <div class="page-block-tidbit">
...
<div id="home_posts">
   ...
   <?php echo form_open(site_url("groups/report_profile/" . $user->ID)) ?>
