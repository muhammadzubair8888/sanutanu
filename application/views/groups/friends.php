...
<?php echo $user->first_name ?> <?php echo $user->last_name ?>
 ...
 <ul>
 	<li><a href="<?php echo site_url("groups/" . $user->username) ?>"><?php echo lang("ctn_200") ?></a></li>
  <li><a href="<?php echo site_url("groups/about/" . $user->ID) ?>"><?php echo lang("ctn_205") ?></a></li>
 	<li class="active"><a href="<?php echo site_url("groups/friends/" . $user->ID) ?>"><?php echo lang("ctn_493") ?></a></li>
   ...
   var st = $('#search_type').val();
    var table = $('#friends-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("groups/friends_page/" . $user->ID) ?>",
            type : 'GET',
            data : function ( d ) {
