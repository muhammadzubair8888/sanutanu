        ...
        <div class="col-md-12">
        	<div class="white-area-content">
        		...
        		<div class="db-header clearfix">
				    <div class="page-header-title"> <span class="glyphicon glyphicon-file"></span> <?php echo lang("ctn_563") ?> <?php echo $page[0]->name ?></div>
				    <div class="db-header-extra"> 
				</div>
				</div>

                <?php echo form_open_multipart(site_url("pages/edit_page_pro/" . $page[0]->ID), array("class" => "form-horizontal")) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control" value="<?php echo $page[0]->name ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_534") ?></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="description" value="<?php echo $page[0]->description ?>">
                    </div>
                </div>
                <?php if(!$this->settings->info->page_slugs) : ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="slug" class="form-control" id="slug-check" value="<?php echo $page[0]->slug ?>">
                ...
                <input type="submit" class="btn btn-post form-control" value="<?php echo lang("ctn_565") ?>">
