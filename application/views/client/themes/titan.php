...
<?php endif; ?>
 ...
 <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyBipO3Bxb7dzzAJb5WwaXJ5CuRh4EU1i8k&libraries=places"></script>
      ...
      <script src="<?php echo base_url() ?>scripts/libraries/croppie.js"></script>
        ...
        <link rel="icon" rel="stylesheet" type="text/css" href="<?php echo base_url() ?>images/favicon/sanutanufav.ico">
          ...
          <div class="col-md-10 mainbar">
            <div class="row">
              ...
              <a class="navbar-brand-two" href="<?php echo site_url() ?>" title="<?php echo $this->settings->info->site_name ?>">
                <img style="width: 100%;height: 100%;" src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $this->settings->info->site_logo ?>" >
              </a>
            <?php else : ?>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text" style="float: left;">
                            <p>Copyright &copy; 2018, All Right Reserved <a href="<?php echo base_url(); ?>">SanuTanu</a></p>
                        </div>
                    </div>
...
var ws = new WebSocket('ws://192.168.1.14:1900');
