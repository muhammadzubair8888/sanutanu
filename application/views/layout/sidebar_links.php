                ...
                <div id="admin_sb_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['admin'])) echo "in" ?>">
                  <ul class="inner-sidebar-links">
                    <?php if($this->user->info->admin || $this->user->info->admin_settings) : ?>
                      ...
                      <li class="<?php if(isset($activeLink['admin']['Globe'])) echo "active" ?>"><a href="<?php echo site_url('admin/globe') ?>"><?php echo lang("ctn_1078"); ?></a></li>
                      <li class="<?php if(isset($activeLink['admin']['cities'])) echo "active" ?>"><a href="<?php echo site_url('admin/cities') ?>"><?php echo lang("ctn_1055"); ?></a></li>
                      ...
                      <li class="<?php if(isset($activeLink['admin']['repoted_post'])) echo "active" ?>"><a href="<?php echo site_url("admin/repoted_post") ?>"> <?php echo lang("ctn_1079") ?></a></li>
