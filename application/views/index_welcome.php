  ...
  <body>
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="index.html">SanuTanu</a>
    			</div>
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><span class="icon-paper-plane" style="color: #a41be3"></span></div>
					    	<div class="text">
					    		<span>Email</span>
						    	<span>sanutanu.social@gmail.com</span>
						    </div>
					    </div>
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><span class="icon-phone2" style="color: #a41be3"></span></div>
						    <div class="text">
						    	<span>Call</span>
						    	<span>Call Us: +47 405 92 600</span>
						    </div>
					    </div>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/bg_1.jpg);">
        ...
        <div class="container">
          ...
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Welcome to SanuTanu</span>
            <h1 class="mb-4">Asia's First Social Networking Website</h1>
      ...
      <div class="slider-item" style="background-image:url(images/bg_2.jpg);">
        ...
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<span class="subheading">Let's Connect With us</span>
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
          ...
          <div class="col-lg-3 col-md-4 ftco-animate">
          	<p class="mb-0"><a href="contact.html" class="btn btn-white py-3 px-4">Request Quote</a></p>
          </div>
        </div>	
    	</div>
    </section>
    ...
    <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(images/bg_5.jpg);" data-stellar-background-ratio="0.5">
    			...
    			<div class="col-md-6 py-5 px-md-5">
		          ...
		          <form action="" class="appointment-form ftco-animate">
		                    ...
		                    <select name="" id="" class="form-control">
		                      ...
		                      <option style="color:black;" value="">Digital Marketing</option>
		                      <option style="color:black;" value="">Business</option>
		                      <option style="color:black;" value="">Web Development</option>
		                      <option style="color:black;" value="">Real Estate</option>
		                      <option style="color:black;" value="">Other Services</option>
		                    </select>
		                  </div>
			              </div>
			    				</div>
            ...
            <div class="blog-entry">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="blog-single.html" class="btn btn-primary" style="background-color:darkgrey;border-color:darkgrey;">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
	                <p class="ml-auto mb-0">
	                	<a href="#" class="mr-2" style="color: black;">Admin</a>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-8 text-center heading-section ftco-animate">
            <h2 class="mb-4">Our Clients Reviews</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	                </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+47 405 92 600</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">sanutanu.social@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
            ...
            <div class="ftco-footer-widget mb-5">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Oct 21, 2019</a></div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="project.html"><span class="ion-ios-arrow-round-forward mr-2"></span>Projects</a></li>
          ...
          <div class="col-md-6 col-lg-3">
            ...
            <div class="ftco-footer-widget mb-5">
                ...
                <li class="ftco-animate"><a href="https://facebook.com/Sanutanu-103846894369682"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="https://instagram.com/thesanutanu"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Muhammad Bilal</a></p>
          </div>
        </div>
      </div>
    </footer>
